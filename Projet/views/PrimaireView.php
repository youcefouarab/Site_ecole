...
class PrimaireView extends View {

    function __construct() {
        parent::__construct();
        $this->controller = new Primaire();
        $articles = $this->controller->getArticles();
        ?>
        <div class="paras-wrapper">
                <h1>Cycle primaire</h1><br><br>
        </div>
        <div class="cadres-wrapper">
        <?php
        require_once VIEWS."CadreView.php";
        new CadreView("Emplois du temps", "emploi.png", "", BASE_URL."emplois/cycle/primaire"); 
        new CadreView("Enseignants", "ens.png", "", BASE_URL."enseignants/cycle/primaire"); 
